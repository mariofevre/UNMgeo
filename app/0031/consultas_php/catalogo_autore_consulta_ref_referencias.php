...
$query="
	SELECT id as id_p_ref_referencias, nombre, ano_publicacion, autores, editorial, formato, zz_borrada
	FROM unmgeo_app0030.ref_referencias
";
...
while($fila=pg_fetch_assoc($Consulta)){	
	$Log['data']['Referencias'][$fila['id_p_ref_referencias']]=$fila;	
}
