...
* @return boolean Retorna true o false
*/
function asegurarFieldName($fieldname) {
	$acum='';
	$permitidos = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_";
	for($i=0 ; $i < strlen($fieldname) ; $i++){
		if(strpos($permitidos, $fieldname[$i]) === false){
...
/**
* elimina de una cadena los no numericos
*
* @param string $filename cadena a testear
* @return boolean Retorna true o false
*/
function extraerCaracteresInt($fieldname) {
	$acum='';
