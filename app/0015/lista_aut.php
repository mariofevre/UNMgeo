...
if(!isset($_GET['modo'])){$_GET['modo']='';} //opciones modo:  soloprincipal / 
...
<head>
	...
	#formfiltro > div.f_modalidad, #formfiltro > div.f_evaluado, #formfiltro > div.f_resultado, #formfiltro > div.f_revision, #formfiltro > div.f_modalidad_ev, #formfiltro > div#busqueda{
		display:none;
	}
	</style>
</head>
	...
	<div id='menusuperior'>
		...
		<form id='formfiltro' action='' method='post' onsubmit='event.preventDefault();'>
			...
			<div class="f_revision">
				...
				<div class="grupo">
					<label class="largo">
						<input type="radio" pref='COMfsentido' name="f_revision" value='orig'><span  class="f_revision" onclick='toogle(this);filtrarFilas();'>original</span>
						</label>    
					<br>
...
<div id='formPresent' modoversion='0'>
	...
	<div class='cuarto'><label>Fecha límite para nueva versión</label><input type='date' name='fecha_lim_nueva_ver'></div>
		...
		<div class='cuarto'><label>Fecha</label><input type='date' name='fecha_presentacion'></div>  
		<div class='cuarto'	><label>Hora</label><input type='time' name='hora_presentacion'></div>  
		<div><label>Link</label><input  name='link_presentacion'></div>  	
		<div><label>Moderador</label><input  name='moderador'></div>  	
...
<div id='formEval' linkeado='no'>
  ...
  <script type="text/javascript">
	...
	<script type="text/javascript" src='./lista_aut/lista_aut_consultas.js'></script>
	<script type="text/javascript" src='./lista_aut/lista_aut_mostrar.js'></script>
