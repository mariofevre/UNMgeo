...
<div id='formEval' linkeado='no'>
  ...
  <script type="text/javascript" src='./instituciones/instituciones_consultas.js'></script>
   <script type="text/javascript" src='./instituciones/instituciones_mostrar.js'></script>
   <script type="text/javascript" src='./instituciones/instituciones_interac.js'></script>
   <script type="text/javascript" src='./instituciones/instituciones_mapa.js'></script>
...
function cartelDeCarga(_estado){
	document.querySelector('#cargando').setAttribute('estado',_estado);
}
